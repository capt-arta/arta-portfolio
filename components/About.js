...
const About = () => {
  return (
    <div id='about' className='w-full md:h-screen p-8 flex items-center py-16 bg-artiysx-bg'>
          ...
          <ScrollAnimation animateIn="slideInUp" animateOnce>
            ...
            <Link href='https://drive.google.com/file/d/1hpYJLjBm2TT84Q-92DF8pkJO0pPP2TJG/view?usp=sharing' className='w-fit' legacyBehavior >
              <a target="_blank" rel="noopener noreferrer">
                <p className='py-2 w-fit text-white hover:text-artiysx-blu underline cursor-pointer'>
                  Check out of my CV.
                </p>
              </a>
            </Link>
