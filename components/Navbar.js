...
const Navbar = () => {
  ...
  return (
    <div className={`${shadow ? 'bg-artiysx-bg/60 backdrop-blur-md' : ''}  duration-200 fixed top-0 z-[9999] w-full flex items-center justify-center px-8 py-4 md:py-5 lg:px-24`} >
